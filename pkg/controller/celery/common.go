...
func (r *ReconcileCelery) ensureDeployment(request reconcile.Request,
	instance *examplev1alpha1.Celery,
...
func (r *ReconcileCelery) ensureService(request reconcile.Request,
	instance *examplev1alpha1.Celery,
	s *corev1.Service,
) (*reconcile.Result, error) {
...
func (r *ReconcileCelery) ensurePVC(request reconcile.Request,
	instance *examplev1alpha1.Celery,
